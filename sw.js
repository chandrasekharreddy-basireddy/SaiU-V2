const CACHE='saiu-v2-v1';
const SHELL=['./','./index.html','./styles.css','./js/app.js','./js/store.js','./js/timetable.js','./js/ai.js','./js/calendar.js','./js/notifications.js','./js/gamification.js','./js/navigation.js','./manifest.json'];
