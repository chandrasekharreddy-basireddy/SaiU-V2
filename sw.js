const CACHE='saiu-v2-v5';
const SHELL=['./','./index.html','./styles.css','./js/app.js','./js/bootstrap.js','./js/store.js','./js/timetable.js','./js/ai.js','./js/calendar.js','./js/notifications.js','./js/gamification.js','./js/navigation.js','./js/social.js','./js/student.js','./js/student-os.js','./js/catalog.js','./js/remote.js','./manifest.json','./icons/icon.svg'];
