...
export const toMinutes=base.toMinutes,fmtMinutes=base.fmtMinutes,duration=base.duration;
export const sortClasses=base.sortClasses,classesForDay=base.classesForDay;
export const conflicts=base.conflicts,freePeriods=base.freePeriods,commonFree=base.commonFree;
export const currentClass=base.currentClass,nextClass=base.nextClass;
