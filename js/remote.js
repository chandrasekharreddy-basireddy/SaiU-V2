...
const REMOTE_TIMEOUT_MS=12000;const MAX_CACHE_ENTRIES=20;
...
function writeEntries(entries){localStorage.setItem(KEY,JSON.stringify(entries.slice(-MAX_CACHE_ENTRIES)));}
