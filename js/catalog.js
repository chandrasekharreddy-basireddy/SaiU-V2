export const CATALOG={
  ...
  schools:[
    ...
    {id:'soai',name:'School of Artificial Intelligence',short:'SOAI',years:[
      {id:'soai-2',label:'Year 2',lvel:2,sections:[1,2],mandatory:['Differential Equations','Frontiers of Machine Learning','Discrete Mathematics','Image Processing','Human AI Interaction'],electives:['Intelligent Embedded Systems','Forensic Psychology']}
    ]},
