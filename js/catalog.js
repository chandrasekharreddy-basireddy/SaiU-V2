export const CATALOG={
  ...
  schools:[
    {id:'scds',name:'School of Computing & Data Science',short:'SCDS',years:[
      {id:'scds-2',label:'Year 2',level:2,sections:[1,2,3],electives:[
      ...
      {id:'scds-3',label:'Year 3',level:3,sections:[1,2,3],mandatory:['Deep Learning','Theory of Computation'],electives:[
    ...
    {id:'soai',name:'School of Artificial Intelligence',short:'SOAI',years:[
      {id:'soai-2',label:'Year 2',level:2,sections:[1,2],mandatory:['Differential Equations','Frontiers of Machine Learning','Discrete Mathematics','Image Processing','Human AI Interaction'],electives:['Intelligent Embedded Systems','Forensic Psychology']}
    ]},
    {id:'sob',name:'School of Business',short:'SOB',years:[
      {id:'sob-2',label:'Year 2',level:2,sections:[1,2],tracks:['BBA','B.Com'],mandatory:['Corporate and Business Law','Operations Research','Human Resource Management','Principles in Financial Management','Principles of Financial Management','Financial Reporting and Analysis']}
    ]},
    {id:'sol',name:'School of Law',short:'SOL',years:[{id:'sol-2',label:'Year 2',level:2,sections:[1,2],sectionsOptional:true}]},
    {id:'sop',name:'School of Psychology',short:'SOP',years:[{id:'sop-2',label:'Year 2',level:2,sections:[1,2]}]}
  ]
};
